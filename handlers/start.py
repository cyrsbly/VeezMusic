        ...
        reply_markup=InlineKeyboardMarkup(
            [ 
                [
                    ...
                    InlineKeyboardButton(
                        "📣 Updates Channel", url=f"https://t.me/katarinamusicbotupdates")
                ],[
                    InlineKeyboardButton(
                        " Bot by Cy! ", url="https://t.me/saibuboo"
                    )
                ]
            ]
        ),
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "✨ Bot Owner", url=f"https://t.me/chimon_nnnnn"
                    ),
                    InlineKeyboardButton(
                        "📣 Channel", url=f"https://t.me/KatarinaMusicBotUpdates"
                    )
                ]
            ]
        )
